  ...
  def __init__(self):
    ...
    self.parser.add_argument('--keep_res', action='store_true',
                             help='keep the original resolution'
                                  ' during validation.')
    # tracking
    self.parser.add_argument('--test_softwarecup', default=False, help='test softwarecup')
    ...
    self.parser.add_argument('--show_images', default=False, help='show images')
    self.parser.add_argument('--save_images', default=False, help='save images')
    self.parser.add_argument('--save_videos', default=False, help='save videos')
    # mot
